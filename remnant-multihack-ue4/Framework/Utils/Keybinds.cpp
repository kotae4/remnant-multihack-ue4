...
* Source: https://github.com/BitCrackers/AmongUsMenu/blob/eaccb54b3bf91df6c9a59f46ab06516b49c7c3d3/user/keybinds.cpp
...
void KeyBinds::to_json(nlohmann::ordered_json& j, KeyBinds::Config value)
{
    j = nlohmann::ordered_json{
        ...
        {"Toggle_Aimbot", value.Toggle_Aimbot},
...
void KeyBinds::from_json(const nlohmann::ordered_json& j, KeyBinds::Config& value)
{
    ...
    j.at("Toggle_Aimbot").get_to(value.Toggle_Aimbot);

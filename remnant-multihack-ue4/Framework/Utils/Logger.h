...
// credit: github.com/t0msa aka tomsa#3313
...
public:
        ...
        -> void
    {
        ...
        std::wstring formatted_messageW = std::vformat(message, std::make_wformat_args(args...));
        std::string formatted_message;
        BOOL success = FALSE;
        success = Utils::Strings::TryConvertUtf16ToUtf8(formatted_messageW, formatted_message);
        if (success == FALSE)
        {
